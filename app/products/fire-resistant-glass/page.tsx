            ...
            >
              <div className="inline-block mb-4">
                <div className="gold-glass rounded-full px-4 py-1.5">
                  <span className="text-gold-platinum text-sm font-medium gold-glow-text">FIRE GLASS TECHNOLOGY</span>
                </div>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold gold-glow-text mb-6">
                Advanced <span className="gold-shimmer">Fire-Resistant Glass</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {glassTypes.map((type, index) => (
              <motion.div 
                key={index}
                className="gold-card rounded-2xl p-6 gold-interactive"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: index * 0.1, duration: 0.5 }}
                whileHover={{ y: -10 }}
              >
                <h3 className="text-xl font-bold text-gold-platinum mb-3 gold-glow-text">
                  {type.name}
                </h3>
