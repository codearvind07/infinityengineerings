            ...
            >
              <div className="inline-block mb-4">
                <div className="gold-glass rounded-full px-4 py-1.5">
                  <span className="text-gold-platinum text-sm font-medium gold-glow-text">FIRE PROTECTION SYSTEMS</span>
                </div>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold gold-glow-text mb-6">
                Fire Curtains / <span className="gold-shimmer">Smoke Curtains</span>
              </h1>
